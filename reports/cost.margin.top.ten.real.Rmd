...
####### Next step is changing component plot away from the explict ingredients from fake data as levels.  Is it even necessary to stipulate these or can it be set by the data levels = vector.name
